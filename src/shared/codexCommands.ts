...
export const CODEX_COMMAND_GROUPS: CmdGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { cmd: 'CODEX_NON_INTERACTIVE=1 codex', kind: 'cli', desc: 'Suppress all interactive installer / first-run prompts. Set automatically by Hello MarkX in auto mode.' }
    ]
  },
  {
    title: 'CONFIG',
