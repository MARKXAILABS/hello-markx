...
```sh
codesign --verify --deep --strict --verbose=2 "dist/mac-universal/Hello MarkX.app"
spctl --assess --type execute --verbose "dist/mac-universal/Hello MarkX.app"   # → "accepted, source=Notarized Developer ID"
xcrun stapler validate "dist/mac-universal/Hello MarkX.app"
```
