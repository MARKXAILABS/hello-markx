...
test('the reported paste: Claude Code blockquote rail is dropped', () => {
  assert.equal(
    sanitizeTerminalSelection('▎ Hello MarkX — clones for you and your team, working 24/7.'),
    'Hello MarkX — clones for you and your team, working 24/7.'
  );
});

test('every line of a multi-line quote loses its rail', () => {
  const copied = [
    '▎ Hello MarkX is live today.',
    '▎',
