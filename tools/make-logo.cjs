'use strict';
/**
 * Hello MarkX brand mark — Michael's portrait on the brand yellow tile.
 *
...
function buildSvg(N, grid, frame, border) {
  ...
  <!-- Hello MarkX — the brand mark, and the source of truth for every raster
